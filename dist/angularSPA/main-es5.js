...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcApp_servicesContactServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ContactService = ContactService_1 = /*#__PURE__*/function () {
      ...
      _createClass(ContactService, [{
        key: "postcontactdata",
        value: function postcontactdata(data) {
          return this.http.post(ContactService_1.BaseUrl + "contacts", data, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
    ...
    ContactService = ContactService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"]])], ContactService);
    /***/
  },
  ...
  function srcApp_servicesUserServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UserService = UserService_1 = /*#__PURE__*/function () {
      ...
      _createClass(UserService, [{
        key: "deletefitnessdata",
        value: function deletefitnessdata() {
          throw new Error("Method not implemented.");
        }
      }, {
        key: "postfitnessdata",
        value: function postfitnessdata(data) {
          return this.http.post(UserService_1.BaseUrl + 'allfriends', data, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            return response.json();
          }));
        }
      }, {
        key: "updatefitnessdata",
        value: function updatefitnessdata(id, data) {
          return this.http.put(UserService_1.BaseUrl + 'allfriends/' + id, data, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            return response.json();
          }));
        }
      }, {
        ...
        value: function getfitnessdata() {
          ...
          var baseURL = UserService_1.BaseUrl + 'allfriends';

          if (id != null) {
            baseURL += "/" + id;
          }

          return this.http.get(baseURL, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            return response.json();
          }));
        }
      }, {
        ...
        value: function deletedata(id) {
          return this.http["delete"](UserService_1.BaseUrl + 'allfriends/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            return response.json();
          }));
        }
      }]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var angular_autofocus_fix__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    /*! @angular/common/http */
    "./node_modules/@angular/common/fesm2015/http.js"); // <--- new code
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_http__WEBPACK_IMPORTED_MODULE_8__["HttpModule"], angular_autofocus_fix__WEBPACK_IMPORTED_MODULE_11__["AutofocusModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_12__["HttpClientModule"]],
  ...
  function srcAppContactUsContactUsComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(ContactUsComponent, [{
        ...
        value: function onSubmit() {
          ...
          if (this.contactForm.status === "VALID") {
            var contactFormData = new Contact(this.contactForm.value.firstname, this.contactForm.value.lastname, this.contactForm.value.phonenumber, this.contactForm.value.email, this.contactForm.value.message);
            this.contactdata.emit(contactFormData);
            this.contactService.postcontactdata({
              ...
              return alert("Contact us request raised !");
            }, function (error) {
              return alert("Error while submitting the form");
            });
          }
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _services_contact_service__WEBPACK_IMPORTED_MODULE_3__["ContactService"]])], ContactUsComponent);
    /***/
  },
  ...
  function srcAppPlaceFitnessTrainerAppointmentPlaceFitnessTrainerAppointmentComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Fitness = function Fitness(firstname, lastname, age, phonenumber, email, streetaddress, city, state, country, pincode, trainerpreference, physiotherapist, packages, inr, paisa) {
    ...
    Fitness.ctorParameters = function () {
      return [{
        type: String
      }, {
        type: String
    ...
    Fitness = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
      selector: "[appautoFocus]"
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [String, String, Number, Number, String, String, String, String, String, Number, String, String, String, Number, Number])], Fitness);

    var PlaceFitnessTrainerAppointmentComponent = /*#__PURE__*/function () {
      function PlaceFitnessTrainerAppointmentComponent(userService, formBuilder, firstnameElement) {
      ...
      _createClass(PlaceFitnessTrainerAppointmentComponent, [{
        ...
        value: function ngOnInit() {
          this.fitnessForm = this.formBuilder.group({
            firstname: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern(this.noNummbersValidation)]],
            lastname: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern(this.noNummbersValidation)]],
            email: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern(this.emailValidation)]],
            age: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].min(19), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].max(59)]],
            phonenumber: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern(this.numberValidation), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(8), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(10)]],
            streetaddress: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
            pincode: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(6), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(6), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern(this.numberValidation)]],
        ...
        value: function onSubmit() {
          ...
          if (this.fitnessForm.valid) {
            this.userService.postfitnessdata(new Fitness(this.fitnessForm.value.firstname, this.fitnessForm.value.lastname.value, this.fitnessForm.value.age, this.fitnessForm.value.phonenumber, this.fitnessForm.value.email, this.fitnessForm.value.streetaddress, this.fitnessForm.value.city, this.fitnessForm.value.state, this.fitnessForm.value.country, this.fitnessForm.value.pincode, this.fitnessForm.value.trainerpreference, "yes", this.fitnessForm.value.packages, this.fitnessForm.value.inr, this.fitnessForm.value.paisa)).subscribe(function (res) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Boolean)], PlaceFitnessTrainerAppointmentComponent.prototype, "appAutoFocus", void 0);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services___WEBPACK_IMPORTED_MODULE_3__["UserService"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]])], PlaceFitnessTrainerAppointmentComponent);
    /***/
  },
  ...
  function srcAppViewAppointmentViewAppointmentComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../_services/ */
    "./src/app/_services/index.ts");
    /* harmony import */
    ...
    var _place_fitness_trainer_appointment_place_fitness_trainer_appointment_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../place-fitness-trainer-appointment/place-fitness-trainer-appointment.component */
    "./src/app/place-fitness-trainer-appointment/place-fitness-trainer-appointment.component.ts");
    ...
    function () {
      function ViewAppointmentComponent(userService, formBuilder) {
      ...
      _createClass(ViewAppointmentComponent, [{
        ...
        value: function ngOnInit() {
          this.getfitness();
          this.fitnessForm = this.formBuilder.group({
            firstname: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern(this.noNummbersValidation)]],
            lastname: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern(this.noNummbersValidation)]],
            email: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].email, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern(this.emailValidation)]],
            age: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].min(19), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].max(59)]],
            phonenumber: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern(this.numberValidation), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(8), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(10)]],
            streetaddress: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required]],
            pincode: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(6), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(6), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern(this.numberValidation)]],
        ...
        key: "editAppointment",
        value: function editAppointment(id) {
          var _this = this;

          this.showEditForm = true;
          this.userService.getfitnessdata(id).subscribe(function (res) {
            _this.setFormFields(res);

            _this.idUpdate = res.id;
          }, function (err) {
        ...
        key: "setFormFields",
        value: function setFormFields(result) {
        ...
        key: "saveAppointment",
        value: function saveAppointment() {
          var _this2 = this;

          if (this.fitnessForm.valid) {
            this.userService.updatefitnessdata(this.idUpdate, new _place_fitness_trainer_appointment_place_fitness_trainer_appointment_component__WEBPACK_IMPORTED_MODULE_4__["Fitness"](this.fitnessForm.value.firstname, this.fitnessForm.value.lastname, this.fitnessForm.value.age, this.fitnessForm.value.phonenumber, this.fitnessForm.value.email, this.fitnessForm.value.streetaddress, this.fitnessForm.value.city, this.fitnessForm.value.state, this.fitnessForm.value.country, this.fitnessForm.value.pincode, this.fitnessForm.value.trainerpreference, "yes", this.fitnessForm.value.packages, this.fitnessForm.value.inr, this.fitnessForm.value.paisa)).subscribe(function (res) {
        ...
        key: "tableUpdate",
        value: function tableUpdate(data) {
          this.tableData = data;
        }
      }, {
        key: "getfitness",
        value: function getfitness() {
          ...
          this.userService.getfitnessdata().subscribe(function (i) {
            return _this3.tableUpdate(i);
          }, function (err) {
            return alert("error");
          });
        }
        ...
        key: "deletefitness",
        value: function deletefitness(id) {
          var confirmDelete = confirm("Confirm to delete ?");

          if (confirmDelete) {
            this.userService.deletedata(id).subscribe(function (i) {
              alert("appointment deleted !");
              location.reload();
            }, function (err) {
              return alert("Error occured while deleting the appointment");
            });
          }
        }
      }]);
    ...
    , tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services___WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]])], ViewAppointmentComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\yakshaangular72\Desktop\Shahjad-Fitness tracker case study-xoriant\angular-fsd-fitness-jest\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
